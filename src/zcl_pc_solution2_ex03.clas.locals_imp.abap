...
CLASS lcl_cargo_flight DEFINITION .
  ...
  PUBLIC SECTION.
    ...
    DATA carrier_id    TYPE /dmo/connection_id    READ-ONLY. " error provoca bucle infinito
    DATA connection_id TYPE /dmo/carrier_id       READ-ONLY. " error provoca bucle infinito
    DATA flight_date   TYPE /dmo/flight_date      READ-ONLY.
*    DATA carrier_id    TYPE /dmo/carrier_id       READ-ONLY.  "corrección para evitar bucle infinito
*    DATA connection_id TYPE /dmo/connection_id    READ-ONLY.  "corrección para evitar bucle infinito
...
*    CLEAR flights_buffer.   " <<< ESTO ES CLAVE
...
*        DATA(days_later) =  i_from_date - flight->flight_date. " ERROR DEVUELVE VALOR NEGATIVO
         DATA(days_later) =   flight->flight_date - i_from_date . " CORRECCION - DEVUELVE CERO
